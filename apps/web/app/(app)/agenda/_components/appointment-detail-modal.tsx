...
export function AppointmentDetailModal({ open, appointmentId, onClose, onChanged }: Props) {
  const titleId = useId();
      ...
      >
        <div className="flex items-start justify-between gap-3 border-b border-border p-5">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Fechar"
            className="-mr-1.5 -mt-1 rounded-md p-1.5 text-muted-foreground hover:bg-surface-alt hover:text-foreground transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
          >
